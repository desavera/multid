...
void
Plot3dScalingMap::apply(const float in[], float out[]) const
{
...
void
Plot3dScalingMap::apply_inverse(const float in[], float out[]) const
{
...
void
Plot3dScalingMap::get_range(float &x_min_, float &x_max_,
...
void
Plot3dScalingMap::set_range(float x_min_, float x_max_,
		float y_min_, float y_max_,
...
{
	plot_3d.set_range(x_min.value(), x_max.value(),
...
Plot3d::Plot3d(const Space &space,
		const char * const x_name,
		const char * const y_name,
		const char * const z_name,
		const Frame &parent,
		int x, int y, int width)
	: View3d(plot_3d_space, parent, Panel::HEIGHT_ONE_ROW, x, y,
		width, width),
	  scaling_map_(space),
...
void
Plot3d::get_range(float &x_min_, float &x_max_,
		float &y_min_, float &y_max_,
		float &z_min_, float &z_max_) const
{
...
void
Plot3d::set_range(float x_min_, float x_max_,
	float y_min_, float y_max_,
	float z_min_, float z_max_)
{
