...
View2d::View2d(const Space &space, const Frame &parent,
		int panel_height, int x, int y, int height, int width)
	: GWin2d(parent, panel_height, x, y, height, width),
	  Scene(space),
	  bbox(space)
{
	init();
...
View2d::View2d(const Scene &scene_, const Frame &parent,
		int panel_height, int x, int y, int height, int width)
	: GWin2d(parent, panel_height, x, y, height, width),
	  Scene(scene_),
	  bbox(scene_.space())
...
View2d::View2d(const Map &map, const Scene &scene_, const Frame &parent,
		int panel_height, int x, int y, int height, int width)
	: GWin2d(parent, panel_height, x, y, height, width),
	  Scene(map, scene_),
	  bbox(map.codomain())
