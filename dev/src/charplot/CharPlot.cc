...
CharPlot::CharPlot(const Frame &parent, std::ifstream & /* input */)
	: View2d(char_plot_space, parent)
{
...
FilenameText::FilenameText(const Panel &panel, CharPlotPanelWin &char_plot_panel_win_)
	: PanelText(panel, 50),
	  message(panel, " "),
...
CharPlotPanelWin::CharPlotPanelWin(const Frame &parent)
	: PanelWin(parent),
	  event_loop(),
